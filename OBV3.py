...
#sched.add_job(bot.order_last, 'cron', hour='*', minute='25')

#sched.add_job(bot.check_contract, 'cron', hour='*', minute='32', args=[0])
#sched.add_job(bot.check_contract, 'cron', hour='*', minute='53', args=[1])
#sched.add_job(bot.check_contract, 'cron', hour='*', minute='13', args=[2])
#sched.add_job(bot.check_contract, 'cron', hour='*', minute='23', args=[3])

sched.add_job(bot.report_balance, 'cron', hour='*', minute='58')
sched.add_job(bot.report, 'cron', hour='00', minute='07')
